...
define("SMTP_UNAME", "techhelpstew@gmail.com");
define("SMTP_PWORD", "ServiceC4mate#");
...
########################################################################
define("WEB_DOMAIN", "techhelpstew.com/tms/"); //ex. demo.orangescrum.com
define('FROM_EMAIL_NOTIFY', 'techhelpstew@gmail.com'); //(REQUIRED)
define('SUPPORT_EMAIL', 'techhelpstew@gmail.com'); //(REQUIRED) From Email
define('FROM_EMAIL',  'Content Management System TMS<'.SUPPORT_EMAIL.'>');

define("DEV_EMAIL", 'techhelpstew@gmail.com'); // Developer Email ID to report the application error
...
define('SUB_FOLDER', 'tms/'); //If your application URL followed by a folder name like: http://your-site.com/folder_name, put your folder name as 'folder_name/'

if(php_sapi_name() === "cli") {
	define('PROTOCOL', "http://");
	define('DOMAIN', "www.techhelpstew.com/"); // Please set your application domain (REQUIRED)
}else{
