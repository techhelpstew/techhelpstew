<?php /* Smarty version Smarty-3.1.19, created on 2016-03-06 13:48:13
         compiled from "/var/www/techhelpstew.com/store/themes/default-bootstrap/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:159301320856dca59dd68f76-76708596%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bd8a8c1b5695f7eb7e864b0886e001a7731e2ada' => 
    array (
      0 => '/var/www/techhelpstew.com/store/themes/default-bootstrap/history.tpl',
      1 => 1457300741,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '159301320856dca59dd68f76-76708596',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56dca59dec7297_73120309',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56dca59dec7297_73120309')) {function content_56dca59dec7297_73120309($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/var/www/techhelpstew.com/store/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp77=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-detail',true,null,"id_order=".$_tmp77), ENT_QUOTES, 'UTF-8', true);?>
');">
...
, '<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp78=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-detail',true,null,"id_order=".$_tmp78), ENT_QUOTES, 'UTF-8', true);?>
');">
								<span>
...
<?php $_tmp79=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".$_tmp79), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php } else { ?>
								<a class="link-button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp80=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".$_tmp80), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
